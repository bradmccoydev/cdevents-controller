...
# install cdevents-controller with tls enabled
helm upgrade --install cdevents-controller ./charts/cdevents-controller \
    --set image.repository=test/cdevents-controller \
